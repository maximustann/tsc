...
\end{IEEEbiography}
\vspace{-9.5 mm}
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{photo/YiMei}}]{Yi Mei} (M’09)
...
\end{IEEEbiography}
\vspace{-9.5 mm}
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{photo/MengjieZhang}}]{Mengjie Zhang} (M’04-SM’10)
